class Ending {
    ...
    draw() {
        ...
        text('Darina Belonogova, Karolina Grabowska, cottonbro studio on Pexels', width/2, height-100);
        ...
        text('Audio by : Percy Duke, theplax on Freesound', width/2, height-50);
        pop();
    }
}